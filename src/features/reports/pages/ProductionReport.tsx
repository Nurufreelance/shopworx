...
import { 
  ...
  PencilSquareIcon,
  ArrowDownTrayIcon,
  DocumentDuplicateIcon,  // ✅ Added missing import
  Squares2X2Icon
  ...
  return (
    <div className="w-[220px] bg-white border-l border-[#E5E7EB] flex flex-col flex-shrink-0 h-full">
      ...
      <div className="px-4 py-3 border-b border-[#E5E7EB]">
        <div className="relative">
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-8 pr-3 py-1.5 text-[13px] border border-[#D8D8D8] rounded-[4px] focus:outline-none focus:ring-1 focus:ring-[#3E4BAA]"
          />
      ...
      <div className="border-b border-[#E5E7EB]">
        <div className="flex">
          <button className="flex-1 text-center py-2.5 text-[13px] font-medium text-[#3E4BAA] border-r border-[#E5E7EB] bg-[#F0F2FF]">
            Columns
          </button>
          <button className="flex-1 text-center py-2.5 text-[13px] text-[#6B7280] hover:text-[#3E4BAA] transition-colors">
            Filters
          </button>
        </div>
      </div>
...
export default function ProductionReport() {
  ...
  return (
    <PageLayout title="Production reports">
      {/* Toolbar */}
      <div className="bg-white border-b border-[#E5E7EB] px-4 py-2.5 flex items-center gap-3 flex-shrink-0">
        <div className="relative" ref={saveAsRef}>
          <button
            onClick={() => setShowSaveAs(!showSaveAs)}
            className="px-4 py-1.5 bg-[#3E4BAA] text-white text-[13px] font-medium rounded-[4px] hover:bg-[#33408F] transition-colors"
          >
          ...
          {showSaveAs && (
            <div className="absolute top-full left-0 mt-1 w-[280px] bg-white border border-[#E5E7EB] rounded-[8px] shadow-lg p-4 z-50">
              ...
              <input
                ...
                className="w-full px-3 py-1.5 border border-[#D8D8D8] rounded-[4px] text-[13px] focus:outline-none focus:ring-1 focus:ring-[#3E4BAA]"
              />
              <div className="flex justify-end gap-2 mt-3">
                <button onClick={() => setShowSaveAs(false)} className="px-3 py-1 text-[13px] text-[#6B7280] hover:bg-[#F8F9FB] rounded-[4px]">
                  Cancel
                </button>
                <button onClick={() => setShowSaveAs(false)} className="px-3 py-1 text-[13px] bg-[#3E4BAA] text-white rounded-[4px] hover:bg-[#33408F]">
                  Save
                </button>
              </div>
            </div>
        ...
        <div className="relative" ref={reportsRef}>
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 border border-[#D8D8D8] rounded-[4px] text-[13px] text-[#333] hover:bg-[#F8F9FB] transition-colors"
          >
      ...
      <div className="bg-white border-b border-[#E5E7EB] px-4 py-2.5 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[16px] font-medium text-[#222]">Machine Production</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <select className="px-3 py-1.5 border border-[#D8D8D8] rounded-[4px] text-[13px] bg-white focus:outline-none focus:ring-1 focus:ring-[#3E4BAA]">
